...
import { getCategoryBreakdown, getSpendingTrend } from "./transactions.controller.js";
 ...
 * GET /category-breakdown and GET /spending-trend; ingestion owns POST /import
 * and PATCH /:id/category.
 */
