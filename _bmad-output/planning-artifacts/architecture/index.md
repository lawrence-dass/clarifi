...
- [Architecture Decision Document](#table-of-contents)
  ...
  - [Starter Template Evaluation](./starter-template-evaluation.md)
    ...
    - [Selected Approach: Hand-rolled pnpm monorepo](./starter-template-evaluation.md#selected-approach-hand-rolled-pnpm-monorepo)
    - [Verified Stack (versions confirmed live, June 2026)](./starter-template-evaluation.md#verified-stack-versions-confirmed-live-june-2026)
    - [Structure](./starter-template-evaluation.md#structure)
  ...
  - [Project Structure & Boundaries](./project-structure-boundaries.md)
    ...
    - [Requirements -> Structure Mapping (by epic)](./project-structure-boundaries.md#requirements-structure-mapping-by-epic)
